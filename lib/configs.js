...
var _init = function(options) {
  ...
  var options.mongoose = options.mongoose || {};
  var options.mongoose.uri = options.mongoose.uri || defaults.mongoose.uri;
  var options.mongoose.options = options.mongoose.options || defaults.mongoose.options;
